    ...
    <div class="backdrop-blur-md p-8 rounded-xl w-full max-w-md shadow-lg "> 
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <p class="text-center mt-4 text-sm text-white">
                Don’t have an account? <a href="<?php echo e(route('register')); ?>" class="text-purple-900 font-semibold">Sign Up</a>
            </p>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\tubes\EventCoba\EventConnect\resources\views/auth/login.blade.php ENDPATH**/ ?>