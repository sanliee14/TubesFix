...
<?php endif; ?>
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <div class="text-sm text-[#FFD1DC] space-x-4">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="hover:text-white">Register</a>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-[#FF69B4]">
        ...
        <div class="pt-4 pb-1 border-t border-pink-300">
            <?php if(auth()->guard()->check()): ?>
                <div class="px-4">
                    <div class="font-medium text-base text-[#FFD1DC]"><?php echo e(Auth::user()->name); ?></div>
                    <div class="font-medium text-sm text-pink-200"><?php echo e(Auth::user()->email); ?></div>
                </div>

                <div class="mt-3 space-y-1">
                    <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('profile.edit'),'class' => 'text-[#FFD1DC] hover:bg-[#FF1493]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('profile.edit')),'class' => 'text-[#FFD1DC] hover:bg-[#FF1493]']); ?>
                        <?php echo e(__('Profile')); ?>
...
<?php endif; ?>
                    ...
                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        ...
                        <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('logout'),'onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'text-[#FFD1DC] hover:bg-[#FF1493]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('logout')),'onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'text-[#FFD1DC] hover:bg-[#FF1493]']); ?>
                            <?php echo e(__('Log Out')); ?>
...
<?php endif; ?>
            ...
            <?php if(auth()->guard()->guest()): ?>
                <div class="px-4 text-sm text-[#FFD1DC] space-y-2">
                    <a href="<?php echo e(route('login')); ?>" class="block py-2 hover:text-white">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="block py-2 hover:text-white">Register</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
