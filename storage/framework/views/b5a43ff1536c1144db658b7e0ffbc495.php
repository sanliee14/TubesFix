...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
  ...
  <body class="bg-cover bg-center min-h-screen" style="background-image: url('<?php echo e(asset('images/10.png')); ?>');">
    <div class="flex justify-center items-center py-6 px-2 mb-0 min-h-[65vh]">
        <div class="bg-gradient-to-br from-black/70 to-slate-800/80 backdrop-blur-md rounded-3xl p-12 max-w-7xl w-full flex flex-col lg:flex-row gap-6 shadow-2xl">
