...
<div class="min-h-screen flex items-center justify-center" style="background-image: url('<?php echo e(asset('images/log.png')); ?>')">
    <div class="backdrop-blur-md p-8 rounded-xl w-full max-w-md shadow-lg">
        ...
        <form method="POST" action="<?php echo e(route('EO.register')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <p class="text-center mt-4 text-sm text-white">
                Already Registered? <a href="<?php echo e(route('login')); ?>" class="text-purple-300 font-semibold">Login</a>
            </p>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\tubes\EventCoba\EventConnect\resources\views/EO/register.blade.php ENDPATH**/ ?>