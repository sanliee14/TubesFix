...
<?php $component->withAttributes([]); ?>
          ...
          <div class="bg-gradient-to-br from-black/70 to-slate-800/80 backdrop-blur-md rounded-3xl p-12 max-w-7xl w-full flex flex-col lg:flex-row gap-10 shadow-2xl">
              ...
              <div class="lg:w-2/3 text-[#f7e7c2] space-y-6">
                  ...
                  <div class="flex gap-6 pt-4">
                      <a href="#about" class="bg-[#5e17eb] hover:bg-violet-400 text-cream font-semibold text-lg px-6 py-3 rounded-full shadow-lg transition">About Us</a>
                      <a href="#help" class="bg-[#5e17eb] hover:bg-violet-400 text-cream font-semibold text-lg px-6 py-3 rounded-full shadow-lg transition">Contact Us</a>
                  </div>
              </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:pr-12">
      ...
      <div class="space-y-6 animate-fade-in text-right md:pl-8">
        ...
        <div class="flex justify-end flex-wrap gap-4 mt-4">
          <a href="<?php echo e(route('user.events')); ?>" class="bg-purple-700 hover:bg-purple-500 text-[#FAEBD7] font-bold py-3 px-6 rounded-xl shadow transition">
            BE A PART OF THE EVENT TEAM
          </a>
          <a href="<?php echo e(route('eo.register')); ?>" class=" bg-[#5e17eb] hover:bg-purple-600 text-[#FAEBD7] font-bold py-3 px-6 rounded-xl shadow transition">
  ...
  <section class="bg-gradient-to-br from-black/70 to-slate-800/80 backdrop-blur-md py-12 px-6 mt-16 rounded-xl shadow-lg max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
      <!-- Step 1 -->
      <div class="bg-purple-200 opacity-100 p-6 rounded-xl shadow-md space-y-4">
      ...
      <!-- Step 2 -->
      <div class="bg-purple-200 p-6 rounded-xl shadow-md space-y-4">
        <div class="text-6xl">📋</div>
    ...
    <div class="mt-10 flex justify-center">
      <a href="<?php echo e(route('user.events')); ?>"
         class="bg-[#5e17eb] hover:bg-purple-400 text-[#FAEBD7] font-semibold px-8 py-3 rounded-full hover:bg-purple-700 transition">
        Daftar Sekarang
      </a>
    </div>
    <div>
  ...
  <div class="fixed bottom-20 right-5 z-50">
    <form method="GET" action="<?php echo e(route('eo.register')); ?>">
     <button
         class="flex items-center justify-center bg-purple-600 text-[#FAEBD7] font-bold rounded-full w-36 h-12 shadow-lg hover:bg-purple-500 transition-all duration-300">
...
<?php endif; ?>
<?php /**PATH C:\Users\nitro\OneDrive\Dokumen\File Coding\LARAVEL\EventConnect\resources\views/dashboard.blade.php ENDPATH**/ ?>