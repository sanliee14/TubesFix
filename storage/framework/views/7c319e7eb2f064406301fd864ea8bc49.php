    ...
    <div class="min-h-screen" style="background-image: url('<?php echo e(asset('images/2.png')); ?>');">
        <div class="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-blue-200/50 backdrop-blur-sm overflow-hidden shadow-sm rounded-2xl">
                <form action="<?php echo e(route('eo.edit.store',$event->id)); ?>" class="flex justify-center p-14 gap-6" enctype="multipart/form-data" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex flex-col gap-4 w-[32rem]">
                        <div class="flex justify-between items-center">
                            ...
                            <input type="text" id="nama" name="nama" class="bg-blue-200 border-none outline-white rounded-full w-80" value="<?php echo e(old('nama', $event->nama_event)); ?>">
                        </div>
                        <div class="flex justify-between items-center">
                            <label for="mulai" class="font-semibold text-lg">Tanggal Mulai</label>
                            <input type="date" id="mulai" name="mulai"class="bg-blue-200  border-none outline-white rounded-full w-80" value="<?php echo e(old('nama', $event->tanggal_mulai)); ?>">
                        </div>
                        <div class="flex justify-between items-center">
                            <label for="selesai" class="font-semibold text-lg">Tanggal Selesai</label>
                            <input type="date" id="selesai" name="selesai" class="bg-blue-200  border-none outline-white rounded-full w-80" value="<?php echo e(old('nama', $event->tanggal_selesai)); ?>">
                        </div>
                        <div class="flex justify-between items-center">
                            <label for="lokasi" class="font-semibold text-lg">Lokasi</label>
                            <input type="text" id="lokasi" name="lokasi" class="bg-blue-200  border-none outline-white rounded-full w-80" value="<?php echo e(old('nama', $event->lokasi)); ?>">
                        </div>
                        <div class="flex flex-col gap-3">
                            <label for="deskripsi" class="font-semibold text-lg">Deskripsi</label>
                            <textarea id="deskripsi" name="deskripsi" class="bg-blue-200 border-none outline-white rounded-xl p-2" value="<?php echo e(old('nama', $event->deskripsi)); ?>"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<?php /**PATH C:\Users\nitro\OneDrive\Dokumen\File Coding\LARAVEL\TubesFix\resources\views/EO/edit.blade.php ENDPATH**/ ?>