    ...
    <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:pr-12">
      ...
      <div class="space-y-6 animate-fade-in text-right md:pl-8">
        ...
        <div class="flex justify-end flex-wrap gap-4 mt-4">
          <a href="{{ route('user.events') }}" class="bg-purple-700 hover:bg-purple-500 text-[#FAEBD7] font-bold py-3 px-6 rounded-xl shadow transition">
            BE A PART OF THE EVENT TEAM
          </a>
          <a href="{{ route('eo.register') }}" class=" bg-[#5e17eb] hover:bg-purple-600 text-[#FAEBD7] font-bold py-3 px-6 rounded-xl shadow transition">
