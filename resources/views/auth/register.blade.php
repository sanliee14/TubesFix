...
@section('content')
<div class="min-h-screen bg-center" style="background-image: url('{{ asset('images/8.png') }}')">
        ...
        <div class="backdrop-blur-md p-8 rounded-xl w-full max-w-md shadow-lg">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <p class="text-center mt-4 text-sm text-white">
                    Already Registered? <a href="{{ route('users.login') }}" class="text-purple-900 font-semibold">Login</a>
                </p>
            </form>
        </div>
    </div>
